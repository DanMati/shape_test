...
def app():
    ...
    with app.app_context():
        db.create_all()
        Migrate(app, db)
        vessel_obj1 = Vessel(vessel_code='MV102')
        vessel_obj2 = Vessel(vessel_code='MV101')
...
def test_insert_with_wrong_sized_code(app):
    result = app.test_client().post('/equipment/insert_equipment', json={'vessel_code':'MV102', 'code':'5310Basdasd9D7', 'location':'brazil'})
